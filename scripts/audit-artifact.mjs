...
const requiredDiagrams = [
  ...
  "server-platforms-map.svg",
  "windows-server-service-map.svg",
  "linux-server-service-map.svg",
...
const requiredM34Routes = [
  ["ly-thuyet", "05-server-platforms", "index.html"],
  ["ly-thuyet", "05-server-platforms", "windows-server", "index.html"],
  ["ly-thuyet", "05-server-platforms", "linux-server", "index.html"],
  ["ly-thuyet", "05-server-platforms", "cloud-server", "index.html"],
]
for (const route of requiredM34Routes) {
  const routePath = path.join("public", ...route)
  if (!fs.existsSync(routePath)) {
